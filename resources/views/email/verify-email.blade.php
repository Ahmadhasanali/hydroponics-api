        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background-color:#1a1c1e;border-radius:24px;padding:32px;border:1px solid rgba(255,255,255,0.1);">
                    ...
                    <tr>
                        <td style="padding-top:24px;color:#ffffff;font-size:22px;font-weight:bold;line-height:1.4;">Verifikasi Email Anda</td>
                    </tr>
                    <tr>
                        <td style="padding-top:12px;color:#cbd5e1;font-size:14px;line-height:1.6;">
                            Halo {{ $name }},<br><br>
                            Klik tombol di bawah untuk memverifikasi alamat email Anda dan mengaktifkan akun. Link ini berlaku selama {{ $expire }} menit.
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding-top:28px;">
                            <a href="{{ $url }}" style="display:inline-block;background-color:#ffce54;color:#1a1c1e;text-decoration:none;font-weight:bold;font-size:14px;padding:14px 32px;border-radius:14px;">Verifikasi Email</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top:28px;color:#94a3b8;font-size:13px;line-height:1.6;">
                            Jika Anda tidak membuat akun ini, abaikan email ini.<br><br>
                            — Kita Tumbuh
                        </td>
                    </tr>
                </table>
