...
@section('content')
    <div class="mx-auto max-w-2xl">
        ...
        <div class="mt-4 rounded-[2rem] border border-slate-200/60 bg-white p-6 shadow-sm shadow-slate-900/5 sm:p-8">
            <h2 class="text-lg font-semibold text-slate-900">Input Penurunan pH (pH Down)</h2>
            <p class="mt-1 text-sm text-slate-500">Catat pH sebelum & sesudah beserta dosis pH Down.</p>

            <form action="{{ route('staff.ph-down.store') }}" method="POST" class="mt-6 space-y-5">
                @csrf
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="ph_before" id="ph_before" step="0.01" min="0" max="14" value="{{ old('ph_before') }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="ph_after" id="ph_after" step="0.01" min="0" max="14" value="{{ old('ph_after') }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="ph_down_ml" id="ph_down_ml" step="0.01" min="0" max="1000" value="{{ old('ph_down_ml') }}" required
