...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The base URL of the SPA frontend. Used to build deep links in emails
    | (e.g. password reset links) that must point at the frontend, since the
    | API no longer ships web routes or Blade views.
    |
    */
